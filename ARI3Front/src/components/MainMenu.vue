<template>
	...
	>
        <el-submenu index="1" :showTimeout="0">
			...
			<router-link to="/"><el-menu-item index="0">Home</el-menu-item></router-link>
			<router-link to="/about"><el-menu-item index="1">About</el-menu-item></router-link>
			<router-link to="/develop"><el-menu-item index="2">Develop</el-menu-item></router-link>
		</el-submenu>
        ...
        <div class="onlineClass" @click="handleClick">
            <el-badge 
                class="item" 
                :value="online.v ? 'Connected' : 'Disconnected'" 
